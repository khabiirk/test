 ...
 *
 * <p>Sample access: curl "http://127.0.0.1:8084/api/username?access_token=...="
 */
@RestController
public class IdentifyUserController {
  ...
  public Collection<SimpleGrantedAuthority> currentUserRole() {
    ...
    return (Collection<SimpleGrantedAuthority>) SecurityContextHolder.getContext()
        .getAuthentication()
        .getAuthorities();
  }
   ...
   *
   * @param principal object representing the owner
